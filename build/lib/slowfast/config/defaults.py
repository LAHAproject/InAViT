...
#
_C.ORVIT.INIT_WEIGHTS = False
_C.ORVIT.ZERO_INIT_ORVIT = False
_C.ORVIT.LOAD_ORVIT_ATTN_LAYERS_FROM_BB = True

# Number of objects
_C.ORVIT.O = 5

# ORViT in model
_C.ORVIT.ENABLE = False
_C.ORVIT.LAYERS = []
_C.ORVIT.ADD_LAYERS = []
_C.ORVIT.USE_MOTION_STREAM = True
_C.ORVIT.MOTION_STREAM_ATTN_TYPE = 'joint'

_C.ORVIT.MOTION_STREAM_DIM = -1
_C.ORVIT.MOTION_STREAM_N_HEADS = 12
_C.ORVIT.MOTION_STREAM_SEP_POS_EMB = False

_C.ORVIT.FIXED_TRAJ = False
...
#
_C.HOIVIT.INIT_WEIGHTS = False
_C.HOIVIT.ZERO_INIT_HOIVIT = False
_C.HOIVIT.LOAD_HOIVIT_ATTN_LAYERS_FROM_BB = True

# Number of objects
_C.HOIVIT.O = 5

# Number of human parts
_C.HOIVIT.U = 2

# HoIViT in model
_C.HOIVIT.ENABLE = False
_C.HOIVIT.LAYERS = []
_C.HOIVIT.ADD_LAYERS = []
_C.HOIVIT.USE_MOTION_STREAM = True
_C.HOIVIT.MOTION_STREAM_ATTN_TYPE = 'joint'

_C.HOIVIT.MOTION_STREAM_DIM = -1
_C.HOIVIT.MOTION_STREAM_N_HEADS = 12
_C.HOIVIT.MOTION_STREAM_SEP_POS_EMB = False

_C.HOIVIT.FIXED_TRAJ = False

_C.HOIVIT.DOUBLEATTENTION = False

_C.HOIVIT.MASK_FG = False

_C.HOIVIT.HANDONLY = False
_C.HOIVIT.OBJONLY = False
...
#
_C.STDVIT.INIT_WEIGHTS = False
_C.STDVIT.ZERO_INIT_STDVIT = False
_C.STDVIT.LOAD_STDVIT_ATTN_LAYERS_FROM_BB = True

# STDVIT in model
_C.STDVIT.ENABLE = False
_C.STDVIT.LAYERS = []
_C.STDVIT.ADD_LAYERS = []
_C.STDVIT.USE_MOTION_STREAM = True
_C.STDVIT.MOTION_STREAM_ATTN_TYPE = 'joint'


_C.STDVIT.HANDONLY = False

# -----------------------------------------------------------------------------
# NaiveCrossViT options
# -----------------------------------------------------------------------------
_C.NAIVECROSSVIT = CfgNode()

#
_C.NAIVECROSSVIT.INIT_WEIGHTS = False
_C.NAIVECROSSVIT.ENABLE = False
# Number of objects
_C.NAIVECROSSVIT.O = 5

# Number of human parts
_C.NAIVECROSSVIT.U = 1

# Upper threshold for Entropy
_C.NAIVECROSSVIT.ENTROPY_THRESHOLD = None
_C.NAIVECROSSVIT.DECAY_RATE = 0.1 # This rate allows Entropy Threshold to reduce by half by 25 epochs

# -----------------------------------------------------------------------------
# MASKEDHOIVIT options
# -----------------------------------------------------------------------------
_C.MASKEDHOIVIT = CfgNode()

#
_C.MASKEDHOIVIT.INIT_WEIGHTS = False
_C.MASKEDHOIVIT.ENABLE = False
# Number of objects
_C.MASKEDHOIVIT.O = 5
...
# Upper threshold for Entropy
_C.MASKEDHOIVIT.ENTROPY_THRESHOLD = None
_C.MASKEDHOIVIT.DECAY_RATE = 0.1 # This rate allows Entropy Threshold to reduce by half by 25 epochs

# motion
_C.MASKEDHOIVIT.USE_MOTION_STREAM = True
_C.MASKEDHOIVIT.MOTION_STREAM_ATTN_TYPE = 'joint'


# -----------------------------------------------------------------------------
# ONLYHOIVIT options
# -----------------------------------------------------------------------------
_C.ONLYHOIVIT = CfgNode()

#
_C.ONLYHOIVIT.INIT_WEIGHTS = False
_C.ONLYHOIVIT.ENABLE = False

# Upper threshold for Entropy
_C.ONLYHOIVIT.ENTROPY_THRESHOLD = None
_C.ONLYHOIVIT.DECAY_RATE = 0.1 # This rate allows Entropy Threshold to reduce by half by 25 epochs


# -----------------------------------------------------------------------------
# UNIONHOIVIT options
# -----------------------------------------------------------------------------
_C.UNIONHOIVIT = CfgNode()

#
_C.UNIONHOIVIT.INIT_WEIGHTS = False
_C.UNIONHOIVIT.ZERO_INIT_UNIONHOIVIT = False
_C.UNIONHOIVIT.LOAD_UNIONHOIVIT_ATTN_LAYERS_FROM_BB = True
...
# UNIONHOIVIT in model
_C.UNIONHOIVIT.ENABLE = False
_C.UNIONHOIVIT.LAYERS = []
_C.UNIONHOIVIT.ADD_LAYERS = []
_C.UNIONHOIVIT.USE_MOTION_STREAM = True
_C.UNIONHOIVIT.MOTION_STREAM_ATTN_TYPE = 'joint'

_C.UNIONHOIVIT.MOTION_STREAM_DIM = -1
_C.UNIONHOIVIT.MOTION_STREAM_N_HEADS = 12
_C.UNIONHOIVIT.MOTION_STREAM_SEP_POS_EMB = False

_C.UNIONHOIVIT.FIXED_TRAJ = False

_C.UNIONHOIVIT.DOUBLEATTENTION = False

_C.UNIONHOIVIT.MASK_FG = False
...
# If positive use different lr for HOIViT
_C.SOLVER.HOIVIT_BASE_LR = -1.0
...
# 
_C.SSV2.DATA_ROOT = '/data/usrdata/ram/SomethingV2'

# _C.SSV2.SPLITS_ROOT = '../ORViT/data/ssv2' # Path to the folder that contains the "dataset_splits" dir provided in "Something-Else"
_C.SSV2.SPLITS_ROOT = '/data/usrdata/ram/SomethingV2' # Path to the folder that contains the "dataset_splits" dir provided in "Something-Else"
...
# Anticipation
_C.EPICKITCHENS.ANTICIPATION = False

# 
_C.EPICKITCHENS.SAVESCORES = False
_C.EPICKITCHENS.JSON_FILE  = 'test.json'

# -----------------------------------------------------------------------------
# EGTEA Dataset options 
# -----------------------------------------------------------------------------
_C.EGTEA = CfgNode()

# Path to EGTEA RGB data directory
_C.EGTEA.VISUAL_DATA_DIR = "/data/dataset/egtea"

# Path to EGTEA Annotation directory
_C.EGTEA.ANNOTATIONS_DIR = "/data/dataset/egtea/action_annotations/anticipation_annotation"

# List of EGTEA TRAIN files
_C.EGTEA.TRAIN_LIST = "training"

# List of EGTEA VAL files
_C.EGTEA.VAL_LIST = "validation"

# List of EGTEA TEST files
_C.EGTEA.TEST_LIST = "validation"

# Split
_C.EGTEA.SPLIT = 1

# Verb-Noun to Action Mapping
_C.EGTEA.ACTIONS_LIST = "action_idx.txt"

# Testing split
_C.EGTEA.TEST_SPLIT = "validation"

# Anticipation
_C.EGTEA.ANTICIPATION = False
_C.EGTEA.ANT_GAP = 0.5
# Frame size for normalization

_C.EGTEA.FRAME_HEIGHT = 480
_C.EGTEA.FRAME_WIDTH = 640

# Threshold for choosing detections
_C.EGTEA.HAND_THRES = 0.0
_C.EGTEA.OBJ_THRES = 0.0
# 
# -----------------------------------------------------------------------------
# AVA Dataset options
# -----------------------------------------------------------------------------
...
_C.AVA.FRAME_DIR = "/home/gamir/DER-Roei/datasets/AVA/download_repo/data/ava/frames"

# Directory path for files of frame lists.
_C.AVA.FRAME_LIST_DIR = (
    "/home/gamir/DER-Roei/datasets/AVA/download_repo/data/ava/frame_lists"
)

# Directory path for annotation files.
_C.AVA.ANNOTATION_DIR = (
    "/home/gamir/DER-Roei/datasets/AVA/download_repo/data/ava/annotations"
)
