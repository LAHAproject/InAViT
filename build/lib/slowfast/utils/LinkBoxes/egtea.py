...
<<<<<<< HEAD
                obj_boxes = []
                for x0,y0,x1,y1,score in fbboxes['obj']:
                    if score >= cfg.EGTEA.OBJ_THRES:
                        obj_boxes.append([x0,y0,x1,y1,score])
                
                dboxes[vid][fid] = obj_boxes
=======
                # obj_boxes = []
                # for x0,y0,x1,y1,score in fbboxes['obj']:
                #     # if score >= cfg.EGTEA.OBJ_THRES:
...
<<<<<<< HEAD
                hand_boxes = []
                for x0,y0,x1,y1,score in fbboxes['hand']:
                    if score >= cfg.EGTEA.HAND_THRES:
                        hand_boxes.append([x0,y0,x1,y1,score])

                dhands[vid][fid] = hand_boxes
=======
                # hand_boxes = []
                # for x0,y0,x1,y1,score in fbboxes['hand']:
                #     # if score >= cfg.EGTEA.HAND_THRES:
